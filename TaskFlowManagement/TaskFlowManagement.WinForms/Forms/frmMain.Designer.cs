namespace TaskFlowManagement.WinForms.Forms
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Helper: style cho từng top-level menu item
            System.Action<System.Windows.Forms.ToolStripMenuItem, string, string> styleMenu =
                (item, text, name) =>
                {
                    item.ForeColor = System.Drawing.Color.FromArgb(226, 232, 240);
                    item.Name      = name;
                    item.Text      = text;
            ...
            styleMenu(this.menuSystem, "⚙  Hệ thống", "menuSystem");
            ...
            styleMenu(this.menuUsers, "👥  Người dùng", "menuUsers");
            ...
            styleMenu(this.menuCustomers, "🏢  Khách hàng", "menuCustomers");
            ...
            styleMenu(this.menuProjects, "📁  Dự án", "menuProjects");
            ...
            styleMenu(this.menuTasks, "✅  Công việc", "menuTasks");
            ...
            styleMenu(this.menuReports, "📊  Báo cáo", "menuReports");
            ...
            // =====================================================
            // STATUS STRIP – Deep navy blue (match menu)
            // =====================================================
