...
| **Lớp** | DH24TH2 |
| **Năm học** | 2025 – 2026 |
| **Tiến độ** | Giai đoạn ✅ (1 / 10 hoàn thành) |
...
- Kéo-thả task giữa các cột *(Giai đoạn 2)*
...
**UC-21: Bình luận & Đính kèm** *(Giai đoạn 2)*
...
### 🔲 Giai đoạn 2 — Quản lý Người dùng & Khách hàng
...
### 🔲 Giai đoạn 3 — Quản lý Dự án

> Mục tiêu: Manager tạo và quản lý dự án, thêm thành viên vào dự án.

**Việc cần làm**
- `frmProjects` (Manager/Admin):
  - DataGridView danh sách dự án, lọc theo Status / Owner
  - Form tạo/sửa dự án: tên, khách hàng, ngày bắt đầu, deadline, ngân sách, priority
  - Đổi trạng thái: `NotStarted → InProgress → OnHold → Completed / Cancelled`
  - Xóa dự án (chỉ khi chưa có task)
- `frmProjectMembers` (Manager/Admin):
  - Danh sách thành viên hiện tại của dự án
  - Thêm developer vào dự án, gán ProjectRole
  - Xóa thành viên: set `LeftAt = UtcNow` (không xóa thật — giữ lịch sử)
- Developer: chỉ thấy dự án mình là thành viên (`GetByMemberAsync`)

**Kết quả bàn giao:** Manager tạo/sửa/xóa dự án được, quản lý thành viên được
